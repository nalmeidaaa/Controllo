...
export default function ModalUsuario({ aberto, usuario, onSalvar, onFechar }) {     
    ...
    async function handleSubmit(e) {     
        ...
        try {     
            ...
            // Identifica qual campo apresentou o erro 
            const mensagemMinuscula = mensagem.toLowerCase();   
   
            const errosServidor = []; 
 
            if (mensagemMinuscula.includes('cpf')) {   
                errosServidor.push('cpf'); 
            } 
 
            if (   
                mensagemMinuscula.includes('e-mail') ||   
                mensagemMinuscula.includes('email')   
            ) {   
                errosServidor.push('email'); 
            } 
 
            if (mensagemMinuscula.includes('nome')) {   
                errosServidor.push('nome'); 
            } 
 
            if (mensagemMinuscula.includes('senha')) {   
                errosServidor.push('senha'); 
            } 
 
            setCamposErro(errosServidor); 
                ...
                <form onSubmit={handleSubmit} noValidate>     
                    ...
                    <div className="modal-footer">     
                        ...
                        >     
                            {salvando   
                                ? 'Salvando…'   
                                : (editando ? 'Salvar Alterações' : 'Salvar Usuário')}     
                        </button>     
                    </div>     
                </form>     
            </div>     
